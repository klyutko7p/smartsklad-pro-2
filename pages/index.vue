...
<template>
  ...
  <div class="mt-5 max-md:px-5" v-cloak>
    ...
    >
      ...
      <div class="max-md:w-full">
        ...
        <select
          name=""
          id=""
          class="bg-transparent border-2 border-secondary-color p-5 rounded-lg w-full"
          @change="changeAddress"
          v-model="selectedAddress"
        >
          <option selected :value="[47.98958366983051, 37.8955255423278]">
            г. Донецк, Буденовский р-н, Заперевальная, ул. Антропова 16 (вход "ремонт
            обуви")
          </option>
          <option :value="[47.945142, 37.960908]">
