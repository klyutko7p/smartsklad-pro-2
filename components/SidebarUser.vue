...
<template>
  ...
  <div
    class="absolute top-0 bottom-0 left-0 right-0 z-40 hidden max-xl:flex items-center justify-center bg-white"
    v-if="isOpen"
  >
    <Icon
  ...
  <div v-else class="p-5 absolute z-40">
    <Icon
      @click="editMenu"
      size="40"
